            ...
            <div>
              ...
              <p className="mt-1 max-w-lg text-sm text-slate-600 dark:text-slate-400">
                {isConnected
                  ...
                  : 'Conecte o número oficial por QR Code para receber mensagens, responder com IA e fazer multiatendimento humano.'}
              </p>
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs text-slate-600 dark:text-slate-400">
              {isConnected
                ...
                : `Status: ${STATUS_LABEL[status] ?? status} · conecte o número da clínica por QR Code`}
            </p>
          </div>
        </div>
        <Link to={connectPath}>
